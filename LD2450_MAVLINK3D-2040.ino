...
uint16_t obstacle_id = 1;       //    Unique ID given to each obstacle so that its movement can be tracked. Use UINT16_MAX if object ID is unknown or cannot be determined.
float x = (ld2450.getTargetX(0)/100);                           //m   X position of the obstacle.
float y = (ld2450.getTargetY(0)/100);                           //m   Y position of the obstacle.
...
uint8_t sensor_type = 0;           //    MAV_DISTANCE_SENSOR Class id of the distance sensor type.
const uint16_t frame = MAV_FRAME_BODY_FRD ;//   MAV_FRAME Coordinate frame of reference.
uint16_t obstacle_id = 2;       //    Unique ID given to each obstacle so that its movement can be tracked. Use UINT16_MAX if object ID is unknown or cannot be determined.
float x = (ld2450.getTargetX(1)/100);                           //m   X position of the obstacle.
float y = (ld2450.getTargetY(1)/100);                           //m   Y position of the obstacle.
float z = 0;                           //m   Z position of the obstacle.
float min_distance = 0 ;         //m   Minimum distance the sensor can measure.
float max_distance = 5;         //m   Maximum distance the sensor can measure.
...
uint8_t sensor_type = 0;           //    MAV_DISTANCE_SENSOR Class id of the distance sensor type.
const uint16_t frame = MAV_FRAME_BODY_FRD ;//   MAV_FRAME Coordinate frame of reference.
uint16_t obstacle_id = 3;       //    Unique ID given to each obstacle so that its movement can be tracked. Use UINT16_MAX if object ID is unknown or cannot be determined.
float x = (ld2450.getTargetX(2)/100);                           //m   X position of the obstacle.
float y = (ld2450.getTargetY(2)/100);                           //m   Y position of the obstacle.
float z = 0;                           //m   Z position of the obstacle.
float min_distance = 0 ;         //m   Minimum distance the sensor can measure.
float max_distance = 5;         //m   Maximum distance the sensor can measure.
